...
/*PD1:RESET  PD0:PWDN*/
#define OV_RESET_SET    { GPIOD->BSHR = GPIO_Pin_1; }  //Output high
#define OV_RESET_CLR    { GPIOD->BCR = GPIO_Pin_1; }  //Output low
#define OV_PWDN_SET     { GPIOD->BSHR = GPIO_Pin_0; }  //Output high
#define OV_PWDN_CLR     { GPIOD->BCR = GPIO_Pin_0; }  //Output low
