...
void DVP_GPIO_Init(void)
{
	...
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource12, GPIO_AF13);  		// D4
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource13, GPIO_AF13); 		// D5
    ...
    GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_12 | GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_15 | GPIO_Pin_6 | GPIO_Pin_2;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
    GPIO_Init(GPIOD, &GPIO_InitStructure);
