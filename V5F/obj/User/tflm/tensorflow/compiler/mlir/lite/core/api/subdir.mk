...
CC_SRCS += \
../User/tflm/tensorflow/compiler/mlir/lite/core/api/error_reporter.cc 

CC_DEPS += \
./User/tflm/tensorflow/compiler/mlir/lite/core/api/error_reporter.d 

OBJS += \
./User/tflm/tensorflow/compiler/mlir/lite/core/api/error_reporter.o 

DIR_OBJS += \
./User/tflm/tensorflow/compiler/mlir/lite/core/api/*.o \

DIR_DEPS += \
./User/tflm/tensorflow/compiler/mlir/lite/core/api/*.d \

DIR_EXPANDS += \
./User/tflm/tensorflow/compiler/mlir/lite/core/api/*.253r.expand \


# Each subdirectory must supply rules for building sources it contributes
User/tflm/tensorflow/compiler/mlir/lite/core/api/%.o: ../User/tflm/tensorflow/compiler/mlir/lite/core/api/%.cc
