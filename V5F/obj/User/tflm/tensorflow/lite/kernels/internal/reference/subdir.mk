...
CC_SRCS += \
../User/tflm/tensorflow/lite/kernels/internal/reference/comparisons.cc \
../User/tflm/tensorflow/lite/kernels/internal/reference/portable_tensor_utils.cc 

CC_DEPS += \
./User/tflm/tensorflow/lite/kernels/internal/reference/comparisons.d \
./User/tflm/tensorflow/lite/kernels/internal/reference/portable_tensor_utils.d 

OBJS += \
./User/tflm/tensorflow/lite/kernels/internal/reference/comparisons.o \
./User/tflm/tensorflow/lite/kernels/internal/reference/portable_tensor_utils.o 

DIR_OBJS += \
./User/tflm/tensorflow/lite/kernels/internal/reference/*.o \

DIR_DEPS += \
./User/tflm/tensorflow/lite/kernels/internal/reference/*.d \

DIR_EXPANDS += \
./User/tflm/tensorflow/lite/kernels/internal/reference/*.253r.expand \


# Each subdirectory must supply rules for building sources it contributes
User/tflm/tensorflow/lite/kernels/internal/reference/%.o: ../User/tflm/tensorflow/lite/kernels/internal/reference/%.cc
