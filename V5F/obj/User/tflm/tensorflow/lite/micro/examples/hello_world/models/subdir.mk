...
CC_SRCS += \
../User/tflm/tensorflow/lite/micro/examples/hello_world/models/hello_world_float_model_data.cc \
../User/tflm/tensorflow/lite/micro/examples/hello_world/models/hello_world_int8_model_data.cc 

CC_DEPS += \
./User/tflm/tensorflow/lite/micro/examples/hello_world/models/hello_world_float_model_data.d \
./User/tflm/tensorflow/lite/micro/examples/hello_world/models/hello_world_int8_model_data.d 

OBJS += \
./User/tflm/tensorflow/lite/micro/examples/hello_world/models/hello_world_float_model_data.o \
./User/tflm/tensorflow/lite/micro/examples/hello_world/models/hello_world_int8_model_data.o 

DIR_OBJS += \
./User/tflm/tensorflow/lite/micro/examples/hello_world/models/*.o \

DIR_DEPS += \
./User/tflm/tensorflow/lite/micro/examples/hello_world/models/*.d \

DIR_EXPANDS += \
./User/tflm/tensorflow/lite/micro/examples/hello_world/models/*.253r.expand \


# Each subdirectory must supply rules for building sources it contributes
User/tflm/tensorflow/lite/micro/examples/hello_world/models/%.o: ../User/tflm/tensorflow/lite/micro/examples/hello_world/models/%.cc
